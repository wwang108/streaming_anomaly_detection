...
class InputModel(BaseModel):
    ...
    spent_transaction_hash: Optional[str] = Field(default=None)  # Hash of the spent transaction
    spend_output_index: Optional[int] = Field(default=None)  # Index of the output in the spent transaction
    script_asm: Optional[str] = Field(default=None)  # Assembly language representation of the script
    script_hex: Optional[str] = Field(default=None)  # Hexadecimal representation of the script
    sequence: Optional[int] = Field(default=None)  # Sequence number
    required_signatures: Optional[int] = Field(default=None)  # Number of required signatures
...
class CreateTransactionCommand(BaseModel):
    ...
    block_hash: Optional[str] = Field(default=None)  # Hash of the block containing the transaction
    ...
    input_count: Optional[int] = Field(default=None)  # Number of inputs in the transaction
    output_count: Optional[int] = Field(default=None)  # Number of outputs in the transaction
    ...
    is_coinbase: Optional[bool] = Field(default=None)  # Flag to indicate if the transaction is a coinbase transaction
