...
class TransactionModel(BaseModel):
    ...
    input_value: Optional[float] = Field(default=None)  # Total value of all inputs in BTC
    output_value: Optional[float] = Field(default=None)  # Total value of all outputs in BTC
    is_coinbase: Optional[bool] = Field(default=None)  # Flag indicating if this is a coinbase transaction
